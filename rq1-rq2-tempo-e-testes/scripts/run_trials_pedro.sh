...
# run_trials_pedro.sh
#
# Roteiro guiado dos 4 trials do Pedro (Lab02 · S02), na ordem e nos
# tratamentos definidos em desenho-experimento/DESIGN.md (seção 7):
#   Trial 1: kata3-calorias      (manual)
#   Trial 2: kata4-gastos        (ia)
#   Trial 3: kata1-cinema        (manual)
#   Trial 4: kata2-torneio-luta  (ia)
#
...
#   ./rq1-rq2-tempo-e-testes/scripts/run_trials_pedro.sh        # os 4 trials
#   ./rq1-rq2-tempo-e-testes/scripts/run_trials_pedro.sh 1 2    # só os trials 1 e 2
#
...
main() {
  ...
  echo
  echo "Sequência do Pedro (DESIGN.md, seção 7):"
  for t in "${TRIALS[@]}"; do
  ...
  echo "  2. git add + commit referenciando a Issue do Pedro (S02)"
  echo "================================================================"
}
